...
void handle_cmd(android_app *app, int32_t cmd) {
    switch(cmd) {
        case APP_CMD_INIT_WINDOW: {
            ...
            core.textures.emplace("averie", std::shared_ptr<Texture>(new Texture("textures/robot_big.png", {GL_RGBA8, GL_RGBA, GL_UNSIGNED_BYTE}, 4)));
    ...
    do {
        ...
        if(!init) {
...

            {
                ...
                anim.animations = {
                        Animation{{
                                          Animation_frame{{ivec4(64, 64, 64, 64)}, 0.2f},
                                          Animation_frame{{ivec4(64, 128, 64, 64)}, 0.2f},
                                          Animation_frame{{ivec4(64, 192, 64, 64)}, 0.2f},
                                          Animation_frame{{ivec4(64, 256, 64, 64)}, 0.2f}
                                  }},
                        Animation{{
                                          Animation_frame{{ivec4(64, 64, 64, 64)}, 0.2f},
                                          Animation_frame{{ivec4(64, 128, 64, 64)}, 0.2f},
                        ...
                        Animation{{
                                          Animation_frame{{ivec4(128, 0, 64, 64)}, 0.2f}
                                  }}
                };
                anim.size = vec2(4.0f, 4.0f);
                anim.rel = vec2(2.0f, 0.0f);
                anim.texture = "averie";
                ...
                ecs.insert_component(entity, anim);
